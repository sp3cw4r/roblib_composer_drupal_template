...
```
composer create-project roblib/roblib_composer_drupal_template:8.x-dev some-dir --stability dev --no-interaction
```
...
* Drupal will be installed in the `some-dir\web` directory.
* Autoloader is implemented to use the generated composer autoloader in `vendor/autoload.php`,
  instead of the one provided by Drupal (`web/vendor/autoload.php`).
* Modules (packages of type `drupal-module`) will be placed in `web/modules/contrib/`
* Modules (packages of type `drupal-custom-module`) will be placed in `web/modules/custom/`
* Theme (packages of type `drupal-theme`) will be placed in `web/themes/contrib/`
* Theme (packages of type `drupal-custom-theme`) will be placed in `web/themes/custom/`
